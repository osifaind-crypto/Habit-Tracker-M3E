  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <nav className="px-6 mb-8">
        <div className="max-w-2xl mx-auto bg-surface p-1.5 rounded-2xl border border-white/5 shadow-lg grid grid-cols-2 gap-1.5">
          <button
            onClick={() => setActiveTab('tasks')}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-semibold transition-all relative ${
              activeTab === 'tasks'
